...
namespace BulkyBook.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(string stripeToken)
        {
            ...
            return RedirectToAction("Details", "Order"/*Controller*/, new { id = orderHeader.Id });
        }
        ...
        public IActionResult CancelOrder(int id)
        {
            ...
            if (orderHeader.PaymentStatus == SD.StatusApproved)
            {
                ...
                orderHeader.OrderStatus = SD.StatusRefuned;
                orderHeader.PaymentStatus = SD.StatusRefuned;
            }
            else
            {
            ...
            switch (status)
            {
                ...
                case "rejected":
                    orderHeaderList = orderHeaderList.Where(o => o.OrderStatus == SD.StatusCancelled
                                                             || o.OrderStatus == SD.StatusRefuned
