...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private TwillioSettings _twillioSettings { get; set; }
        private readonly UserManager<IdentityUser> _userManager;
        [BindProperty]
        public ShoppingCartVM ShoppingCartVM { get; set; }

        public CartController(IUnitOfWork unitOfWork, IEmailSender emailSender,
            UserManager<IdentityUser> userManager,IOptions<TwillioSettings> twillioSettings)
        {
            _unitOfWork = unitOfWork;
            _emailSender = emailSender;
            _userManager = userManager;
            _twillioSettings = twillioSettings.Value;
        }
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            if (stripeToken == null)
            {
                //oder will be created for delayed payment for authorized company
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            try
            {
                var message = MessageResource.Create(
                    ...
                    body: "Order placed on Bulky Book. Your ID:" + id,
                    from: new Twilio.Types.PhoneNumber(_twillioSettings.PhoneNumberTwillio),
